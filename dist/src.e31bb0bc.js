...
(_console = console).log.apply(_console, ["Filtramos todos los libros del array library por su propiedad isRead: "].concat(library));
...
var slotMachine = /*#__PURE__*/function () {
  function slotMachine() {
    ...
    this._restart = 0;
    this._resultado = {};
    this._ruletaA = Math.random() < 0.5 ? true : false;
    this._ruletaB = Math.random() < 0.5 ? true : false;
    this._ruletaC = Math.random() < 0.5 ? true : false;
  }
...
maquina1.play();
maquina1.play();
console.log(maquina1._ruletaA);
console.log(maquina1._ruletaB);
console.log(maquina1._ruletaC);
...
},{}]},{},["../../../../Users/manue/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
