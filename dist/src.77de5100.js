...
var isBookread = function isBookread(books, anyTitle) {
  return books.some(function (book) {
    return book.title === anyTitle && book.isRead === true;
  }, console.log(anyTitle));
};
  ...
  _createClass(SlotMachine, [{
    ...
    value: function getResult() {
      if (this.getRandom() && this.getRandom() && this.getRandom()) {
        console.log("Felicidades!!! Has ganado ".concat(this.container, " monedas"));
        this.container = 0;
      } else {
        this.container++;
        console.log("Has perdido, sigue intentándolo. ");
        console.log("Bote: ".concat(this.container));
      }
    }
  }, {
    key: "play",
...
},{}]},{},["../../../../Users/manue/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
